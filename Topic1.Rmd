...
Watson (1913) coined the term ‘behaviourism’, which is a theory assuming that behaviour is observable and can be traced back to other observable events. The goal of Behaviourism is to explain relationships between stimuli, responses and concequences.
...
2. Mesosystem: The connection/interaction of 2 microsystems (parent/teacher interviews, birthday party, etc)
...
1. _Human lives situated in historical time and place_
    ...
    - _Period Effect:_ A historical event can influence the development of individuals across differing birth cohorts in a similar way.
...
> Bronfenbrenner's theory focussed on the individual.
>
> Elder's theory focussed on social environments.
